...
try {
    ...
    // require_once 'db_connect.php'; // Uncomment and adjust
...
<section id="differs">
  <div class="differs-inner">
    ...
    <div class="differs-image" data-aos="fade-left" data-aos-duration="800" data-aos-delay="150">
      <img src="diff_reader.png" alt="Reader surrounded by story fragments" class="differs-img"/>
    </div>
...
const waveItems1 = [
  ...
  { icon: '⚔️', text: 'Game Arena',                  cls: 'highlight' },
...
const waveItems2 = [
  { icon: '✍️', text: 'Multi-Role Platform',   cls: '' },
