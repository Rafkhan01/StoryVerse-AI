...
// Check if a success message from signup is present in the session
if (isset($_SESSION['message'])) {
    list($message_type, $message) = explode('|', $_SESSION['message'], 2);
        ...
        if (empty($user_name) || empty($first_name) || empty($last_name) || empty($email) || empty($password)) {
            ...
            try {
                ...
                if ($stmt->fetchColumn() > 0) {
                    ...
                    // Set a session message for the user to be picked up by JS
                    $_SESSION['message'] = 'success|Registration successful! Please sign in with your new account.';
