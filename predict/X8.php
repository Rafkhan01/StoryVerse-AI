...
$userPrediction = "No way is it just a dream. This is a trap! Aris is definitely a
digital consciousness, and the real Aris is the one on the bed, probably being held
captive. The 'Revelation Chamber' is the control room for this digital prison. The
'glitches' were actual attempts by the real world to either communicate with him, or
perhaps even attempts he made subconsciously to break through. Part 2 will be about
digital Aris finding a way to escape the simulation, maybe by interfacing with the
outside world through the very systems he thought he was debugging. He'll then have
to wake up his real body and confront the shadowy organization that put him there";
$actualStory = "The Simulacrum Key
...
//$pythonScript = 'C:\\Users\\ACER\\text_similarity_tfidfvector.py';
// Corrected line below:
$pythonScript = "C:\\Users\\ACER\\text_similarity_tfidfvector.py";

// This array defines the streams for stdin, stdout, and stderr
...
$command = "\"$pythonExecutable\" \"$pythonScript\"";

$process = proc_open($command, $descriptorspec, $pipes);

if (is_resource($process)) {
    // Write the JSON data to stdin
    ...
    echo "Failed to open Python process.\n";
}
?>