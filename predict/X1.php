<?php
// Example input: prediction and actual story parts as variables
...
$userPredictionLower = strtolower($userPrediction);
$actualStoryLower = strtolower($actualStory);

// Calculate similarity
similar_text($userPredictionLower, $actualStoryLower, $similarityPercent);

// Display results
echo "Similarity percentage: " . $similarityPercent . "%\n";
?>
